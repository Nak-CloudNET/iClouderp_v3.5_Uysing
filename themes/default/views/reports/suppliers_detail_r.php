...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('Suppliers Report Detail'); ?></h2>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                foreach ($getAllSupplier as $product) {
                                    $pr[$product->supplier_id] = $product->supplier ;
                                    // $pr1[$product->id]=$product->code;
                                }
                                echo form_dropdown('supplier', $pr, (isset($_POST['supplier']) ? $_POST['supplier'] : ""), 'class="form-control" id="product" data-placeholder="' . $this->lang->line("select") . " " . $this->lang->line("supplier") . '"');
...
//                $this->erp->print_arrays($purchase_id);
                ...
                foreach ($purchase_id as $cu){
                    $count++;
                    ?>
                    <tr style=""><td colspan="11" style=""><b><?php echo $cu->supplier;?></b></td></tr>

                    <?php

                    $product_detail = $this->reports_model->getPurchaseDataAll_r($cu->supplier_id, $reference_no1,$start,$end,$biller_ii);
