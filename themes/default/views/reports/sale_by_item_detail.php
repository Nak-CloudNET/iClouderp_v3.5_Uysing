...
//                $this->erp->print_arrays($product_detail);
                ...
                <table class="table table-bordered table-striped table-hover"  >
                    ...
                    <tr style=""><td colspan="11" style=""><b><?php echo $cu->product_code;?></b></td></tr>
                        ...
                        <?php
                        $product_detail = $this->reports_model->getProductDataAll($cu->product_code,$customer_id, $reference_no, $biller_id,$start,$end,$pro_code1);
...
//                        $this->erp->print_arrays($product_detail);
                        foreach ($product_detail as $aa) {
                            ...
                            $total_price += $aa->unit_price;
                            $total_amt += $aa->unit_price *$aa->quantity;
                            $balance += $aa->unit_price *$aa->quantity;
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td style="text-align: right"><?php echo number_format($aa->unit_price,2) ;?>&nbsp;</td>
