              ...
              <table width="100%">
                  <tr>
                      ...
                      <td width="40%" style="vertical-align: bottom; ">
                          ...
                          <h3 class="text-center header1">វិក័យប័ត្រ ដឹកជញ្ជូន</h3>
                          <h3 class="text-center header1"><b>Delivery Invoice</b></h3><br>
                          <div class="box" >
                              <?php
                                ...
                                <table width="100%" class="tfoot_ch">
                                    ...
                                    if($invs->paid>0){
                                        ...
                                        <tr style="border-bottom: 1px solid black;">
                                            ...
                                            <td style="border-right: none;background: white"><?php echo $this->erp->formatMoney($invs->real_paid); ?></td>
                                        </tr>
                                    <?php
